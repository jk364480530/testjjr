<?php $this->load->view('user/user_header')?>
        <div class="site-content">
            <h1 class="site-h1">修改安全密码</h1>
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">原安全密码:</label>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit="" lay-filter="change_safe_pwd">立即提交</button>
                        <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                    </div>
                </div>
            </form>
        </div>
<script src="<?=config_item('domain_static')?>home/js/user/change_safe_pwd.js"></script>
